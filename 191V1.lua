...
function smoothTeleport(targetCFrame, duration)
    ...
    -- Smooth tween dengan 100 steps untuk sangat smooth (10 detik)
    ...
    for i = 1, steps do
        ...
        -- Pastikan HRP di posisi yang tepat
        ...
        elseif percent < 50 then
            LoadingStatus.Text = "TELEPORTASI SANGAT SMOOTH..."
    ...
    -- Final position dengan sempurna (paksa beberapa kali untuk memastikan)
    for i = 1, 3 do
...
-- TP Functions dengan smooth teleport 10 detik
